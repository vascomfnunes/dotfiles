# Setup fzf
# ---------
if [[ ! "$PATH" == */Users/vasco.nunes/.fzf/bin* ]]; then
  export PATH="${PATH:+${PATH}:}/Users/vasco.nunes/.fzf/bin"
fi

# Auto-completion
# ---------------
[[ $- == *i* ]] && source "/Users/vasco.nunes/.fzf/shell/completion.zsh" 2> /dev/null

# Key bindings
# ------------
source "/Users/vasco.nunes/.fzf/shell/key-bindings.zsh"
