...
set_hl('TelescopeSelection', { bg = dark_gray, fg = fg })
set_hl('TelescopeMatching', { fg = green })
set_hl('FloatBorder', { fg = gray, bg = 'NONE' })
set_hl('NormalFloat', { bg = 'NONE' })
set_hl('NeoTreeCursorLine', { bg = dark_gray, fg = fg })
...
set_hl('WinBar', { fg = fg })
set_hl('IblIndent', { fg = dark_gray })
set_hl('SpellBad', { fg = bg, bg = red })
